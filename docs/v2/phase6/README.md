...
3. ADR-0010 (Skill vs Runbook), ADR-0012 (approval bound to plan digest),
   ADR-0017 (versioning) and the Phase 6 ADRs ADR-0024..ADR-0027 are promoted
   from Proposed.
...
| `adrs/ADR-0024..ADR-0027` | Phase 6 decisions (Proposed) |
...
| `../adrs/ADR-0007-least-privilege-credentials.md` | Base decision; refined by `capability-and-credential-requirements.md` + ADR-0026 |
...
| `../adrs/ADR-0012-approval-immutable-plan-digest.md` | Base decision; specialized to the `runbook_digest`→`plan_digest` chain in ADR-0025 |
