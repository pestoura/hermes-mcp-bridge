...
|---|---|---|
| ADR-0024 | Compile-once canonical runbook IR and fail-closed admission | ADR-0004, ADR-0010 |
| ADR-0025 | Runbook digest, plan digest and approval binding | ADR-0012, ADR-0021 |
| ADR-0026 | Runbook least privilege by computed capability set | ADR-0006, ADR-0007, Phase 3 credential split |
| ADR-0027 | Computed `destructive_action` marker and declared rollback support | ADR-0014, ADR-0023 |
